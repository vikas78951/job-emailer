      ...
      <div className="mx-auto max-w-2xl py-10">
        ...
        <div className="text-center">
          <h1 className="text-5xl font-semibold tracking-tight text-balance text-foreground sm:text-7xl">
            Reach Companies, Track Outreach.
          </h1>
          <p className="mt-8 text-lg font-medium text-pretty text-foreground/70 sm:text-xl/8">
            Use our focused emailer tool to send personalized job application
            emails to companies, track which HRs youve contacted, and manage
